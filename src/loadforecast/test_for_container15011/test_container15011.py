...
ewma_smoothing("..\data\c_15011_CPU_util.csv")
f_CPU = pd.read_csv("..\data\c_15011_CPU_util.csv",usecols=['ds','smoothed_CPU'])
f_CPU.columns=['ds','y']
f_CPU.to_csv("..\data\CPU_util.csv")    

df_CPU = pd.read_csv('..\data\CPU_util.csv')
...
forecast_CPU_24h_middle.to_csv("..\data\\c_15011_CPU_forecast_middle.csv",index=False)

forecast_CPU_24h_up = forecast_CPU_24h[['ds', 'yhat_upper']]
forecast_CPU_24h_up.to_csv("..\data\\c_15011_CPU_forecast_24h_up.csv",index=False)

forecast_CPU_24h_low = forecast_CPU_24h[['ds', 'yhat_lower']]
forecast_CPU_24h_low.to_csv("..\data\\c_15011_CPU_forecast_24h_low.csv",index=False)
